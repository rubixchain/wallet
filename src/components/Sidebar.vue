      ...
      <div class="fixed flex flex-col top-0 left-0 w-64 h-full">
        ...
        <div class="rounded flex justify-center">
          <div class="rounded shadow-md h-48 w-48 p-6 flex flex-col justify-around">
            <div>
              <p class="text-base dark:text-gray-600 text-black">Wallet Balance</p>
            </div>
            <div>
              <p class="text-2xl text-green-500 font-bold">RBX {{balance}}</p>
            </div>
            <div class="text-sm">
              <p class="dark:text-gray-600 text-black">Since last month</p>
            </div>
          </div>
        </div>
        ...
        <div class="overflow-y-auto overflow-x-hidden flex-grow">
          <ul class="flex flex-col py-4 space-y-5">
            ...
            <li>
              <a @click="$router.push({name:'Explorer'})" class="duration-200 ease-in-out relative flex flex-row items-center h-11 focus:outline-none hover:bg-grey-50 dark:text-gray-600 text-black hover:dark:text-white border-l-4 border-transparent hover:border-red-500 dark:border-indigo-500 pr-6">
                <span class="inline-flex justify-center items-center ml-4">
            ...
            <li>
              <a  @click="$router.push({name:'Wallet'})" class="duration-200 ease-in-out relative flex flex-row items-center h-11 focus:outline-none hover:bg-grey-50 dark:text-gray-600 text-black hover:dark:text-white border-l-4 border-transparent hover:border-red-500 dark:border-indigo-500 pr-6">
                <span class="inline-flex justify-center items-center ml-4">
            ...
            <li>
              <a @click="$router.push({name:'Transactions'})" class="duration-200 ease-in-out relative flex flex-row items-center h-11 focus:outline-none hover:bg-grey-50 dark:text-gray-600 text-black hover:dark:text-white border-l-4 border-transparent hover:border-red-500 dark:border-indigo-500 pr-6">
                <span class="inline-flex justify-center items-center ml-4">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path></svg>
                </span>
            ...
            <li>
              <a @click="$router.push({name:'Contacts'})" class="duration-200 ease-in-out relative flex flex-row items-center h-11 focus:outline-none hover:bg-grey-50 dark:text-gray-600 text-black hover:dark:text-white border-l-4 border-transparent hover:border-red-500 dark:border-indigo-500 pr-6">
                <span class="inline-flex justify-center items-center ml-4">
