...
<header class="lg:pr-64 dark:text-gray-400 dark:bg-gray-900 body-font">
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <div class="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
      <button @click="syncCall" class="inline-flex items-center bg-red-200 dark:bg-gray-800 border-0 py-1 px-3 focus:outline-none hover:bg-red-700 dark:hover:bg-gray-700 rounded text-base mt-4 md:mt-0"> {{sync}}
