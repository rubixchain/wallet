        ...
        <div class="container px-5 py-10 mx-auto flex flex-wrap">
          <div class="flex flex-wrap w-full">
            ...
            <div class="lg:w-2/5 md:w-2/5 bg-red-200 dark:bg-gray-800 bg-opacity-50 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
              ...
              <button @click="initiateTransaction" class="dark:text-white dark:tbg-indigo-500 bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-300 dark:hover:bg-indigo-600 rounded text-lg">Initiate Transaction</button>
