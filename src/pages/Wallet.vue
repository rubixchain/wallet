    ...
    <div id="Wallet">
        <section class="dark:text-gray-400 dark:bg-gray-900 body-font">
            <div class="container px-5 py-5 mx-auto">
                ...
                <h1 class="sm:text-3xl text-2xl font-medium text-center title-font dark:text-white mb-4">RubiX wallet</h1>
                </div>
                ...
                <div class="p-2  w-full">
                    ...
                    <span class="dark:text-indigo-400 tracking-widest font-medium title-font">DID</span>
                    <span class="px-3 title-font font-medium dark:text-white">{{dashboardData.did}}</span>
                    </div>
                </div>
                <div class="p-2  w-full">
                    <div class="bg-red-200 dark:bg-gray-800 rounded flex p-4 h-full items-center">
                    <span class="dark:text-indigo-400 tracking-widest font-medium title-font">WID</span>
                    <span class="px-3 title-font font-medium dark:text-white">{{dashboardData.wid}}</span>
                    </div>
                </div>
                <div class="p-2  w-full">
                    <div class="bg-red-200 dark:bg-gray-800 rounded flex p-4 h-full items-center">
                    <span class="dark:text-indigo-400 tracking-widest font-medium title-font">Last Transaction</span>
                    <span class="px-3 title-font font-medium dark:text-white">{{lastTxn}}</span>
                    </div>
                </div>
                <div class="p-2 sm:w-1/2 w-full">
                    <div class="bg-red-200 bg-red-200 dark:bg-gray-800 rounded flex p-4 h-full items-center">
                    <span class="dark:text-indigo-400 tracking-widest font-medium title-font">Contacts</span>
                    <span class="px-3 title-font font-medium dark:text-white">{{dashboardData.contactsCount}}</span>
                    </div>
                </div>
                <div class="p-2 sm:w-1/2 w-full">
                    <div class="bg-red-200 dark:bg-gray-800 rounded flex p-4 h-full items-center">
                ...
                <div class="p-2 sm:w-1/2 w-full">
                    <!-- <div class="bg-red-200 dark:bg-gray-800 rounded flex p-4 h-full items-center">
                    <span class="dark:text-indigo-400 tracking-widest font-medium title-font">Transaction</span>
                    <span class="px-3 title-font font-medium dark:text-white">20</span>
                    </div> -->
                </div>
                </div>
