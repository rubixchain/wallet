    ...
    <div id="Wallet">
        <section class="text-gray-400 bg-gray-900 body-font">
            <div class="container px-5 py-5 mx-auto">
                ...
                <div class="p-2 sm:w-1/2 w-full">
                    <div class="bg-gray-800 rounded flex p-4 h-full items-center">
                    <span class="text-indigo-400 tracking-widest font-medium title-font">Transactions</span>
                ...
                <div class="p-2 sm:w-1/2 w-full">
                    ...
                    <button @click="mine" class="flex mx-auto text-white tbg-indigo-500  border-0 py-2 px-8 focus:outline-none hover:bg-red-300 hover:bg-indigo-600 rounded text-sm">Mine Token</button>
                    </div>
                    </div>
                </div>
                <div class="p-2 sm:w-1/2 w-full">
                ...
                <button @click="$router.push({name:'DashboardHome'})" class="flex mx-auto mt-16 text-white tbg-indigo-500  border-0 py-2 px-8 focus:outline-none hover:bg-red-300 hover:bg-indigo-600 rounded text-lg">Go Dashboard</button>
            </div>
            </section>
    </div>
</template>
