  ...
  <div id="Transactions">
    <section class="text-gray-400 bg-gray-900 body-font">
      <div class="container px-5 mx-auto">
        <div class="flex flex-wrap -m-4 text-center">
          ...
          <div class="p-4 sm:w-1/4 w-1/2">
            <h2 class="title-font font-medium sm:text-4xl text-3xl text-white">
              {{ stats.credits.unspentCredits }}
            </h2>
            <p class="leading-relaxed">Credits Remaining</p>
          </div>
          <div class="p-4 sm:w-1/4 w-1/2">
            <h2 class="title-font font-medium sm:text-4xl text-3xl text-white">
              {{ stats.credits.spentCredits }}
            </h2>
          ...
          <div class="p-4 sm:w-1/4 w-1/2">
            ...
            <p class="leading-relaxed">Transactions Received</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container px-5 py-10 mx-auto flex flex-wrap flex-col">
        <div class="flex mx-auto flex-wrap mb-20">
          <a
            ...
            "
            v-bind:class="{
              'bg-gray-800 border-red-500 border-indigo-500 text-white rounded-t':
                openTab === 1,
              '': openTab !== 1,
            }"
          >
    ...
    <section class="text-gray-400 bg-gray-900 body-font">
      <div class="container px-5 mx-auto flex flex-wrap">
        <div
          v-for="(t, index) in txns"
          :key="(t, index)"
          class="flex relative pb-8 sm:items-center md:w-2/3 mx-auto"
        >
          <div
          ...
          >
            <div class="flex-grow sm:pl-3 mt-6 sm:mt-0">
              <h2
                v-on:click="toggleModal(t.txn)"
                class="font-medium title-font text-white mb-1 text-xl"
              >
                {{ t.txn }}
              </h2>
              <span class="p-1 title-font font-medium text-white"
                >{{ t.nickname }}

                <button
                  v-show="!t.edit"
                  v-on:click="editContact(t)"
                  class="
                    pl-2
                    text-sm
                    inline-flex
                ...
                <input
                  ...
                  class="
                    w-1/2
                    bg-opacity-20 bg-transparent
                    ring-2 ring-indigo-900
                    rounded
              ...
              <div>
                ...
                <h2 v-if="openTab != 2" class="mb-1 text-l">
                  sender: {{ t.senderDID }}
                </h2>
                <h2 v-if="openTab != 3" class="mb-1 text-l">
                  receiver: {{ t.receiverDID }}
                </h2>
      ...
      <div class="relative w-auto my-6 mx-auto max-w-6xl">
        ...
        >
          ...
          <div
            ...
            "
          >
            <h3 class="text-3xl font-semibold">Transaction Details</h3>
            <button
              class="
                p-1
                ml-auto
          ...
          <div class="relative p-6 flex-auto">
            ...
            <h2 class="mb-1 text-l">
              totalTime: {{ details.totalTime }} milli seconds
            </h2>
...
export default {
  ...
  methods: {
    ...
    saveContact: function (person) {
      ...
      axios
        .post("http://localhost:1898/addNickName", formData, {
          headers: {
    ...
    toggleModal: function (txn) {
      ...
      axios
        .post("http://localhost:1898/getTxnDetails", {
          transactionID: txn,
        })
        .then((response) => {
    ...
    dashboard() {
      axios
        ...
        .then((response) => {
          this.stats = response.data.data.response;
        })
        .catch(function (error) {
          console.log(error);
        });
