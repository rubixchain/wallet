  ...
  <div class="container px-5 py-0 mx-auto">
    <div class="flex flex-wrap -m-4 text-center">
      ...
      <div class="p-4 sm:w-1/2 w-1/2">
        ...
        <p class="leading-relaxed">Nodes Online</p>
      </div>
        ...
        <div class=" bg-gray-800 bg-opacity-40 p-0 rounded">
          <a class="inline-flex items-center">
            <span class="flex-grow flex flex-col pl-4 py-2">
              <span class="title-font font-medium text-white text-sm">{{cntx.did}}</span>
              <span class="p-1 title-font font-medium text-white">{{cntx.nickname}}
                
                <!-- <button v-show="!cntx.edit && cntx.nickname==null" v-on:click="editContact(cntx)" class="pl-2 text-sm inline-flex items-center  bg-gray-800 border-0 py-0 px-2 focus:outline-none  hover:bg-gray-700 rounded mt-0 md:mt-0">
                  set nickname
                </button>
                <button v-show="!cntx.edit" v-on:click="editContact(cntx)" class="pl-2 text-sm inline-flex items-center  bg-gray-800 border-0 py-0 px-2 focus:outline-none  hover:bg-gray-700 rounded mt-0 md:mt-0">
                  edit
                </button>
                <button v-show="cntx.edit" v-on:click="saveContact(cntx)" class="pl-2 text-sm inline-flex items-center  bg-gray-800 border-0 py-0 px-2 focus:outline-none  hover:bg-gray-700 rounded mt-0 md:mt-0">
                  save
                </button> -->
              </span>
            ...
            <button @click="payment(!payBox)" class="bg-gray-800 inline-flex py-3 px-5 rounded-lg items-center  hover:bg-gray-700 hover:bg-opacity-50 focus:outline-none">
              <span class="ml-4 flex items-start flex-col leading-none">
                <span class="text-xs text-blue-700 text-gray-500 mb-1">make</span>
            ...
            <button @click="$router.push({name:'Transactions'})" class="bg-gray-800 inline-flex py-3 px-5 rounded-lg items-center  hover:bg-gray-700 hover:bg-opacity-50 focus:outline-none">
              <span class="ml-4 flex items-start flex-col leading-none">
                <span class="text-xs text-blue-700 text-gray-500 mb-1">view all</span>
