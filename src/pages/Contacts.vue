        ...
        <div class=" bg-red-200 dark:bg-gray-800 bg-opacity-40 p-0 rounded">
          ...
          <a class="inline-flex items-center">
            <span class="flex-grow flex flex-col pl-4 py-1">
              <span class="title-font font-medium dark:text-white">{{cntx.nickname}}</span>
        ...
        <!-- <div class=" bg-red-200 dark:bg-gray-800 bg-opacity-40 p-0 rounded">
          ...
          <a class="inline-flex items-center">
            <span class="flex-grow flex flex-col pl-4">
              <span class="title-font font-medium dark:text-white">QmZc4J31mnSRgvwShpHgBugLaFsGd2ZUGyCeZpLVuf3Qnn</span>
            </span>
          </a>
        </div> -->
      </div>
